...
SQL is the language used to communicate with the Relational Database. A Relational Database is a program which holds the data in a collection of tables.


- [x] Why do tables need a `primary key`?

A primary key is a unique identifier given to each data point in the table so that we do not have issues keeping track of the information
...
A conjoining table that connects the many to many table.
